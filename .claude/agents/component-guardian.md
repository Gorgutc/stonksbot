...
For each ACTIVE profile: verify the work stays within the profile's declared scope and explicit-defers, and that its verify command exists or that AGENTS.md/.agent-kit.json explicitly document a no-code/readiness exception. Once code/toolchain lands for an active profile, verify commands must exist.
